...
QT_MOC_LITERAL(3, 24, 9), // "dataReady"
QT_MOC_LITERAL(4, 34, 4), // "data"
QT_MOC_LITERAL(5, 39, 17), // "processConnection"
QT_MOC_LITERAL(6, 57, 8), // "readData"
QT_MOC_LITERAL(7, 66, 14) // "onDisconnected"

    },
    "ClientHandler\0finished\0\0dataReady\0"
    "data\0processConnection\0readData\0"
    "onDisconnected"
};
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataReady((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->processConnection(); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientHandler::dataReady)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ClientHandler::dataReady(const QString & _t1)
{
