...
QT_MOC_LITERAL(7, 82, 24), // "replyFinished_getWeather"
QT_MOC_LITERAL(8, 107, 14), // "QNetworkReply*"
QT_MOC_LITERAL(9, 122, 5), // "reply"
QT_MOC_LITERAL(10, 128, 14), // "getWeatherInfo"
QT_MOC_LITERAL(11, 143, 10) // "startTimer"

    },
    "WeatherInfo\0updateWeather\0\0cityName\0"
    "cityTemperture\0weatherStatus\0"
    "weatherImagePath\0replyFinished_getWeather\0"
    "QNetworkReply*\0reply\0getWeatherInfo\0"
    "startTimer"
};
...
void WeatherInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WeatherInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 1: _t->replyFinished_getWeather((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 2: _t->getWeatherInfo(); break;
...
QT_INIT_METAOBJECT const QMetaObject WeatherInfo::staticMetaObject = { {
    ...
    qt_meta_stringdata_WeatherInfo.data,
    qt_meta_data_WeatherInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
